...
1) 기본법 (Q1978)
2) 제곱근을 이용한 기본 판별법
3) 에라토스테네스의 체 (Q1929_2)

## 소인수분해 문제(Q11653)

## 소수 구하기 문제2
기존 기본법으로 구현한 로직 사용 시 시간 초과됨(Q1929)   

## 왜 소수 문제가 많이 나오고 중요하게 다루는가?
### 암호 때문이다. 임의의 수를 곱하기는 쉽지만 역으로 소인수분해 하는 것은 어렵다.

#### 129자리 수를 소인수 분해 할 수 있는가?
```java
...
#### 617 자리의 수는 얼마나 오래 걸릴지 가늠이 안된다. 그래서 실제로도 대부분의 인터넷뱅킹도 RSA-2048 을 쓰고 있다.
```java
